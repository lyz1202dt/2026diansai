...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_Modify_Ctrl_Mode(uint8_t addr, uint32_t svF, uint8_t ctrl_mode)
{
  uint8_t cmd[16] = {0};
...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_En_Control(uint8_t addr, uint32_t state, uint32_t snF)
{
  uint8_t cmd[16] = {0};
...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_Vel_Control(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc, uint32_t snF)
{
  uint8_t cmd[16] = {0};
...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_Pos_Control(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc, uint32_t clk, uint32_t raF, uint32_t snF)
{
  uint8_t cmd[16] = {0};
...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_Stop_Now(uint8_t addr, uint32_t snF)
{
  uint8_t cmd[16] = {0};
...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_Origin_Set_O(uint8_t addr, uint32_t svF)
{
  uint8_t cmd[16] = {0};
...
/**
  ...
  * @retval   ��ַ + ������ + ����״̬ + У���ֽ�
  */
void Emm_V5_Origin_Modify_Params(uint8_t addr, uint32_t svF, uint8_t o_mode, uint8_t o_dir, uint16_t o_vel, uint32_t o_tm, uint16_t sl_vel, uint16_t sl_ma, uint16_t sl_ms, uint32_t potF)
{
  uint8_t cmd[32] = {0};
...
void Emm_V5_Pos_ControlEx(uint8_t addr,float angle,float cur_angle,float dt)     //����ĳ�������Ŀ��λ�úͼ��ٶ�
{
  uint16_t vel=(uint16_t)(ABS((angle-cur_angle)/(0.01f*360.0f/60.0f)*1.2f));   //��������������Ҫ���ٶ�
  if(vel>3000)
    vel=3000;
  if(angle>=0.0f)
